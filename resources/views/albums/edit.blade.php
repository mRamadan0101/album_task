...
@section('content')
        ...
        <form method="POST" action="{{route('albums_store')}}" enctype="multipart/form-data" style="color: black">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('title') ? 'is-invalid' : '' }}" type="text" name="title" id="title" required value="{{ $album->title}}">
                @if($errors->has('title'))
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('description') ? 'is-invalid' : '' }}" type="text" name="description" id="description" required >{{ $album->description}}</textarea>
